...
\usepackage{atbegshi}      % Permite crear reglas para el inicio del documento
...
\usepackage{totpages}      % Permite obtener número de páginas totales
...
\ifthenelse{\equal{\fontdocument}{newtx}}{
...
\ifthenelse{\equal{\fontdocument}{venturis}}{
	...
	\throwbadconfig[nostop]{Fuente desconocida}{\fontdocument}{(Fuentes recomendadas) lmodern,carial,arial2,times,mathptmx,helvet,opensans,mathpazo,cambria,libertine,newtx,custom}
...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={8.4.3},
		Template.Version.Hash={3D4B370A048F9D2F095245E0E4555A3B},
		Template.Version.Release={8.4.3},
	...
	pdfproducer={Template-Informe v8.4.3 | (Pablo Pizarro R.) ppizarror.com},
...
% Corrige soporte para librerías stfloats y floatpag
\makeatletter
\let\fps@style\@empty
\let\rotfps@style\@empty
\newcommand*\floatpagestyle[1]{\gdef\fps@style{#1}}
\newcommand*\rotfloatpagestyle[1]{\gdef\rotfps@style{#1}}
\AddToHook{shipout/before}{%
	\ifx\fps@style\@empty\else
	\if@fcolmade
	\thispagestyle{\fps@style}%
	\fi
	\fi
}
\@ifpackageloaded{rotating}{%
	\RequirePackage{etoolbox}%
	\AtBeginEnvironment{sidewaysfigure}{%
		\ifx\rotfps@style\@empty\else \thispagestyle{\rotfps@style}\fi}
	...
	\ifthenelse{\equal{\portraitstyle}{style13}}{%
		...
		\begin{flushleft}
			\begin{minipage}{0.625\linewidth}
				% Aqui no se puede hacer nada con \universitydepartment
				\ifthenelse{\equal{\universityname}{\xspace}}{%
...
\newcommand{\templatePagecfg}{%
	...
	\ifthenelse{\equal{\hfstyle}{style11}}{% Similar a 1
		...
		\newcommand{\COREstyledefinition}{%
			...
			\fancyhead[R]{\small \thepage \namepageof \getpagerefnumber{TotPages}}
			\ifthenelse{\equal{\hfwidthwrap}{true}}{%
				\fancyfoot[L]{%
					\begin{minipage}[t]{\hfwidthtitle\linewidth}
						\begin{flushleft}
