"""
Método SCS Curve Number (CN) para escorrentía.

Implementa el método del Número de Curva del Servicio de
Conservación de Suelos (SCS/NRCS).
"""
...
from .infiltration import get_minimum_infiltration_rate
